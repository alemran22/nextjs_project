...
export default function Home() {
  return (
    <div>
      ...
      {/* Event page */}
      <div className="md:p-11 w-full max-w-[1440px] mx-auto bg-background-img">
        {/* hero section start*/}
        ...
        <section className="w-1/2 py-12 pl-4">
          {/* events & guests */}
          ...
          <div className="w-full flex flex-row gap-5 justify-between mb-7 pl-6">
            ...
            <div className="flex flex-col gap-[6px] w-3/5">
              ...
              <p className=" font-inter text-sm font-normal">
                ...
                October 31st! Last year, the brand made its debut with us at the
                legendary Brooklyn venue, featuring artists like Iglesias and
                Melanie...
              </p>
            </div>
            {/* Event Information */}
